...
This directory vendors local runtime dependencies so `bridge.luau` does not fetch code from third-party hosts at runtime.

## LuauRegExp

- Upstream: `https://github.com/notpoiu/LuauRegExp`
- Vendored file in this repo: `pattern_engine.luau`
...
- License: Apache-2.0
- Vendored license: `LICENSES/Cobalt-LICENSE.md`
